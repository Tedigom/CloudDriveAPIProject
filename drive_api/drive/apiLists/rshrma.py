...
# 6-2. 파일/폴더 공유 share user 추가 (resource share member add, rshrma)


@api_view(['GET','POST'])
def resource_share_member_add(request):
    ...
    contents = ''
    fullURL = 'http://localhost:8001/logapi/log/?datetime={0}&type=rshrma&userID={1}&parentDirID=0&contents={3}&resourceID={4}&shareID={2}&shareUsersID={5}'.format(
